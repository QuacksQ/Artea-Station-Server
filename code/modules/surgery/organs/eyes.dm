/obj/item/organ/eyes
	...
	decay_factor = STANDARD_ORGAN_DECAY//threshold at 20
...
/obj/item/organ/eyes/robotic/xray/Insert(mob/living/carbon/eye_owner, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
	if(!.)
		return
...
/obj/item/organ/eyes/night_vision/maintenance_adapted/Insert(mob/living/carbon/adapted, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
	if(!.)
		return
