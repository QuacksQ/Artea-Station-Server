...
/obj/item/organ/heart/cursed/Insert(mob/living/carbon/accursed, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
	if(!.)
		return
...
/obj/item/organ/heart/ethereal/Insert(mob/living/carbon/owner, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
...
/obj/item/organ/heart/ethereal/Remove(mob/living/carbon/owner, special = FALSE)
