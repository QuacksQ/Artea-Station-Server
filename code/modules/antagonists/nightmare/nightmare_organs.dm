...
/obj/item/organl/brain/shadow/nightmare
	name = "tumorous mass"
...
/obj/item/organ/brain/shadow/nightmare/Insert(mob/living/carbon/M, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
	if(!.)
		return
...
/obj/item/organ/brain/shadow/nightmare/Remove(mob/living/carbon/M, special = FALSE, no_id_transfer = FALSE)
	QDEL_NULL(our_jaunt)
	return ..()
...
/obj/item/organ/heart/nightmare/Insert(mob/living/carbon/M, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
	if(!.)
		return
